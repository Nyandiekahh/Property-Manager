...
const Sidebar = () => {
  ...
  return (
    <motion.aside
      ...
      className="w-64 sidebar flex flex-col h-full"
    >
      {/* Logo */}
      ...
      <div className="p-4 border-t border-slate-700">
        <motion.div
          ...
          className="bg-slate-800 p-4 rounded-xl text-center border border-slate-600"
        >
          ...
          <p className="text-slate-400 text-xs mb-3">Get advanced analytics and unlimited properties</p>
